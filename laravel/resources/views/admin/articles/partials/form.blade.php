...
<script src="{{ asset('vendor_ghost/ckeditor/ckeditor.js') }}"></script> --}}
...
<textarea type="text" class="form-control" id="description_short" name="description_short" placeholder="Краткое описание" value="{{$article->description_short or ""}}" ></textarea>
<label for="">Описание</label>
<textarea type="text" class="form-control" id="description" name="description" placeholder="Описание" value="{{$article->description or ""}}" ></textarea>
...
<input type="text" class="form-control" name="image" placeholder="Путь до изображения" value="{{$article->image or ""}}" >
<label for="">Публиковать изображение</label>
<select class="form-control" name="image_show" placeholder="Публиковать изображение" value="{{$article->image_show or ""}}" >
